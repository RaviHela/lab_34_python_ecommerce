...
# Part 2 - Product Modeling (Python)
...
# Part 3 - Customer Segmentation (R)
...
# Part 4 - Customer Modeling (Python)
...
```{r}
cluster_morphology_tbl %>%
    select(cluster, count, sum, cat_0, cat_1, cat_2, cat_3, cat_4, cat_5, cat_NA) %>%
